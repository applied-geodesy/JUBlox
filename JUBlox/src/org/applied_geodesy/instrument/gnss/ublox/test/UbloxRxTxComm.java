...
package org.applied_geodesy.instrument.gnss.ublox.test;

import org.applied_geodesy.instrument.gnss.GNSSPosition;
import org.applied_geodesy.instrument.gnss.ublox.TEPUB353;
import org.applied_geodesy.io.rxtx.rxtxcomm.RxTxCommunicator;

import gnu.io.CommPortIdentifier;

public class UbloxRxTxComm {
	public static void main (String args[]) throws Exception {
		System.out.println("Starte Messung via UbloxRxTxComm");
		
		RxTxCommunicator comm = new RxTxCommunicator();
		comm.setCommPortIdentifier(CommPortIdentifier.getPortIdentifier("COM4"));
		comm.setBaudRate(9600);
		
		TEPUB353 usbLogger = new TEPUB353(comm);
